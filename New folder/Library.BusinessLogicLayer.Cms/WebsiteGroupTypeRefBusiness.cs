...
namespace Library.Cms.BusinessLogicLayer {
    public partial class WebsiteGroupTypeRefBusiness : IWebsiteGroupTypeRefBusiness { 
        private IWebsiteGroupTypeRefRepository _res;
        public WebsiteGroupTypeRefBusiness(IWebsiteGroupTypeRefRepository res) 
		{
            _res = res;
        }
...
/// <returns></returns>
 public List<WebsiteGroupTypeRefModel> Search(int pageIndex, int pageSize, char lang,out long total  , string group_type_name) {
            return _res.Search(pageIndex, pageSize, lang,out total  , group_type_name);
        }
/// <summary>
