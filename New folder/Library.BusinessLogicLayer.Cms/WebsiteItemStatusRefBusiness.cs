...
namespace Library.Cms.BusinessLogicLayer {
    public partial class WebsiteItemStatusRefBusiness : IWebsiteItemStatusRefBusiness { 
        private IWebsiteItemStatusRefRepository _res;
        public WebsiteItemStatusRefBusiness(IWebsiteItemStatusRefRepository res) 
		{
            _res = res;
        }
...
/// <returns></returns>
 public List<WebsiteItemStatusRefModel> Search(int pageIndex, int pageSize, char lang,out long total  , string item_status_name) {
            return _res.Search(pageIndex, pageSize, lang,out total  , item_status_name);
        }
/// <summary>
